...
model = joblib.load('https://github.com/RichmondsTetteh/About_Recommendation_System_Project/blob/main/item_prediction_model.pkl')
vectorizer = joblib.load('https://github.com/RichmondsTetteh/About_Recommendation_System_Project/blob/main/count_vectorizer.pkl')
